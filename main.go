...
func main() {
	...
	app := cli.App("brands-rw-neo4j", "A RESTful API for managing People in neo4j")
	...
	graphitePrefix := app.StringOpt("graphitePrefix", "",
		"Prefix to use. Should start with content, include the environment, and the host name. e.g. content.test.brands.rw.neo4j.ftaps58938-law1a-eu-t")
